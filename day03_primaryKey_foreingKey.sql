...
==================================================================================================*/
/*------------------------------------------------------------------------
"tedarikci1" isimli bir tablo olusturun. 
...
create table tedarikci1(

tedarikci_id int,
tedarikci_ismi varchar(15),
iletisim_isim varchar(20),
constraint tedarikci1_pk primary key (tedarikci_id)
);
...
references tedarikci1(tedarikci_id) 
);

select * from tedarikci1;
select * from urunler;

/*------------------------------------------------------------------------
"bebeler" isimli bir tablo olusturun. 
Tabloda "id", "ismi", "iletisim" field'lari olsun 
